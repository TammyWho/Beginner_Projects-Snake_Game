...
//Colours
Color blue = {21, 32, 53, 255};
Color light_blue = {128, 178, 255, 255};
Color orange={255, 140, 0, 255};
Color light_green= {144, 238, 144, 255};
//Grid System where a cell is of size 30px and their count is 25.
int cellSize = 30;
int cellCount = 25;
int offset = 75;
...
public:
	...
	Food(deque<Vector2> snakeBody){
		Image image = LoadImage("carrot.png");
...
int main () {
	...
	*/
	...
	while (WindowShouldClose() == false){
		...
		DrawText("Snake Game",offset -5, 20, 40, orange);
